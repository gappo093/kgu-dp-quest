      ...
      applicationQuestions: [
        {
          dpKey: 'know',
          stemPre:
            '専門分野の知識や技能を使って、問題を解決することは、次のうちどれと最も強く関係すると思いますか？',
          stemPost:
            '専門分野の知識や技能を使って、問題を解決することは、Know/See/Think/Actのどれと最も強く関係すると思いますか？',
        },
        {
          dpKey: 'see',
          stemPre: '複数の立場から社会課題を考えることは、次のうちどれと最も強く関係すると思いますか？',
          stemPost:
            '複数の立場から社会課題を考えることは、Know/See/Think/Actのどれと最も強く関係すると思いますか？',
        },
        {
          dpKey: 'think',
          stemPre:
            '問いを立て、データや情報をもとに筋道を立てて考え、自分の意見を分かりやすく説明することは、次のうちどれと最も強く関係すると思いますか？',
          stemPost:
            '問いを立て、データや情報をもとに筋道を立てて考え、自分の意見を分かりやすく説明することは、Know/See/Think/Actのどれと最も強く関係すると思いますか？',
        },
        {
          dpKey: 'act',
          stemPre:
            '多様な立場の人々と協力しながら、社会の課題解決に向けて自ら行動することは、次のうちどれと最も強く関係すると思いますか？',
          stemPost:
            '多様な立場の人々と協力しながら、社会の課題解決に向けて自ら行動することは、Know/See/Think/Actのどれと最も強く関係すると思いますか？',
        },
      ],
